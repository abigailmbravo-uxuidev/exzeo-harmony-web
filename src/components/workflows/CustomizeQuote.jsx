  ...
  render() {
    ...
    <form className="fade-in" id="customize-quote" onSubmit={this.handleSubmit}>
      <div className="form-group survey-wrapper" role="group">
        <h3 className="section-group-header">Coverage Limits</h3>
      ...
      <div className="form-group survey-wrapper" role="group">
        <h3 className="section-group-header">Coverage Options</h3>
        <div className="form-group segmented" role="group">
          <label className="group-label label-segmented">
      ...
      <div className="form-group survey-wrapper" role="group">
        <h3 className="section-group-header">Deductibles</h3>
        <div className="form-group segmented" role="group">
          <label className="group-label label-segmented">
