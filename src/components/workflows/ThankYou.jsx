        ...
        <div className="contact-message">
          <div className="card card-thanks">
            <div className="card-header image card-header-image-thanks">
              <h4><i className="fa fa-smile-o" /> Thank You</h4>
            </div>
            <div className="card-block">
              <h4 className="error-message">Please check your email for a link to continue</h4>
              <p>Thanks for choosing TypTap. We have sent your client all required
                documents to sign electronically. Once we receive their signature,
                 we will notify you via email.
               </p>
              <p>If you have any issues, please contact one of our representatives
                 to further assist you.</p>
