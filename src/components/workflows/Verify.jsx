...
//
// let Summary = ({ initialValues, quote, state, styleName,
//   handleSubmit, handleOnSubmit, handleChange,
//   effectiveDate,
...
//                       <dd>{`${property.physicalAddress.city},
// ${property.physicalAddress.state} ${
...
//                         <dt>Phone Number</dt>
//                         <dd>{index === 0 ? policyHolderPhoneNumber1 :
// policyHolderPhoneNumber2}</dd>
//                         <dt>Email</dt>
...
//                         <i className="fa fa-pencil" /> Edit </label>
//                       <Field
//                         name="editConfirmPolicyHolder"
// id="editConfirmPolicyHolder" component="input" type="checkbox"
//                         style={{ display: 'none' }}
//                       />
//                     </div> }
//                   </dl>
...
//     const confirmAdditionalInterestsDetails =
// selector(state, 'confirmAdditionalInterestsDetails');
//
