        ...
        <div className="scroll">
          <div className="form-group detail-wrapper">
            ...
            <div className="button-group">
              ...
              <button className="btn btn-secondary" type="button" onClick={() => this.AddAdditionalInsured()} data-test="additional-insured_add"><div><i className="fa fa-plus" /><span>Additional Insured</span></div></button>
