      ...
      <div className="contact-message">
        <div className="card card-csr">
          <div className="card-header">
            <h4>
              <i className="fa fa-exclamation-triangle" /> Underwriting Error(s)
              - Please contact us
            </h4>
          </div>
          <div className="card-block">
            ...
            <p>
              Contact a TypTap customer service representative so we may further
              assist you in obtaining a quote.
            </p>
            <div className="contact-methods">
              <a href="tel:8442897968">
                <i className="fa fa-phone" /> (844) 289-7968
              </a>
              <a href="mailto:customerservice@typtap.com">
                <i className="fa fa-envelope" /> email us
              </a>
            </div>
          </div>
          <div className="card-footer">
            ...
            <small>
              A TypTap CSR may be able to correct your underwriting error(s)
              allowing you to refresh and continue.
            </small>
            <div className="btn-group">
              <a href="tel:8442897968" className="btn btn-secondary btn-round">
