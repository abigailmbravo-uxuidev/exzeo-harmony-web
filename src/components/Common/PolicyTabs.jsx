...
const PolicyTabs = ({ activeTab, policyNumber }) =>
  <nav className="nav-tabs">
    <Link to={{ pathname: `/policy/${policyNumber}/policyHolder` }} className={`btn btn-tab ${activeTab === 'policyHolder' ? 'active' : ''}`}><i className="fa fa-vcard" /><span>Policyholder</span></Link>
    ...
    <Link to={{ pathname: `/policy/${policyNumber}/billing` }} className={`btn btn-tab ${activeTab === 'billing' ? 'active' : ''}`}><i className="fa fa-money" /><span>Billing</span></Link>
