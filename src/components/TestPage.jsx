              ...
              <form className="fade-in" id="survey">
                <div className="form-group survey-wrapper" role="group">
                  ...
                  <div className="form-group segmented monthsOccupied  " role="group">
                    ...
                    <div className="segmented-answer-wrapper">
                      <div className="radio-column-4">
                        <label className="label-segmented" for="0"><input type="radio" value="0-3" name="monthsOccupied"/>
                          <span>0-3</span>
                        </label>
                      </div>
                      <div class="radio-column-4">
                        <label className="label-segmented" for="1"><input type="radio" value="4-6" name="monthsOccupied"/>
                          <span>4-6</span>
                        </label>
                      </div>
                      <div class="radio-column-4">
                        <label className="label-segmented" for="2"><input type="radio" value="7-9" name="monthsOccupied"/>
                          <span>7-9</span>
                        </label>
                      </div>
                      <div className="radio-column-4">
                        <label className="label-segmented" for="3"><input type="radio" value="10+" name="monthsOccupied"/>
                          <span>10+</span>
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="form-group segmented floodCoverage  " role="group">
                    ...
                    <div className="segmented-answer-wrapper">
                      <div className="radio-column-3">
                        <label className="label-segmented" for="0"><input type="radio" value="Yes" name="floodCoverage"/>
                          <span>Yes</span>
                        </label>
                      </div>
                      <div className="radio-column-3">
                        <label className="label-segmented" for="1"><input type="radio" value="No" name="floodCoverage"/>
                          <span>No</span>
                        </label>
                      </div>
                      <div className="radio-column-3">
                        <label className="label-segmented" for="2"><input type="radio" value="Unsure" name="floodCoverage"/>
                          <span>Unsure</span>
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="form-group segmented rented  " role="group">
                    ...
                    <div className="segmented-answer-wrapper">
                      <div className="radio-column-3">
                        <label className="label-segmented" for="0"><input type="radio" value="Yes" name="rented"/>
                          <span>Yes</span>
                        </label>
                      </div>
                      <div className="radio-column-3">
                        <label className="label-segmented" for="1"><input type="radio" value="Occasionally" name="rented"/>
                          <span>Occasionally</span>
                        </label>
                      </div>
                      <div className="radio-column-3">
                        <label className="label-segmented" for="2"><input type="radio" value="Never" name="rented"/>
                          <span>Never</span>
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="form-group segmented fourPointUpdates  " role="group">
                    ...
                    <div className="segmented-answer-wrapper">
                      <div className="radio-column-3">
                        <label className="label-segmented" for="0"><input type="radio" value="Yes" name="fourPointUpdates"/>
                          <span>Yes</span>
                        </label>
                      </div>
                      <div className="radio-column-3">
                        <label className="label-segmented" for="1"><input type="radio" value="No" name="fourPointUpdates"/>
                          <span>No</span>
                        </label>
                      </div>
                      <div className="radio-column-3">
                        <label className="label-segmented" for="2"><input type="radio" value="Unknown" name="fourPointUpdates"/>
                          <span>Unknown</span>
                        </label>
                      </div>
                    </div>
                  ...
                  <div className="form-group segmented previousClaims  " role="group">
                    ...
                    <div className="segmented-answer-wrapper">
                      <div className="radio-column-5">
                        <label className="label-segmented" for="0"><input type="radio" value="0" name="previousClaims"/>
                          <span>0</span>
                        </label>
                      </div>
                      <div className="radio-column-5">
                        <label className="label-segmented" for="1"><input type="radio" value="1" name="previousClaims"/>
                          <span>1</span>
                        </label>
                      </div>
                      <div className="radio-column-5">
                        <label className="label-segmented" for="2"><input type="radio" value="2" name="previousClaims"/>
                          <span>2</span>
                        </label>
                      </div>
                      <div className="radio-column-5">
                        <label className="label-segmented" for="3"><input type="radio" value="3+" name="previousClaims"/>
                          <span>3+</span>
                        </label>
                      </div>
                      <div className="radio-column-5">
                        <label className="label-segmented" for="4"><input type="radio" value="Unknown" name="previousClaims"/>
                          <span>Unknown</span>
                        </label>
                      </div>
                    </div>
