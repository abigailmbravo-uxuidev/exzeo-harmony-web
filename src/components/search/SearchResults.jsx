...
const SearchResults = (props) => {
  props.appState.data.dontSeeAddress
  if (
      ...
      <div>
        ...
        <div className="card address-not-found">
          ...
          { props.appState.data.dontSeeAddress && <div>
            ...
            <p>If you still have problems finding an address, please <a href="tel:888-210-5235"><strong>call us</strong></a> and one of our
              representatives will be glad to help you.</p>
          </div>
          }
        </div>
      </div>
