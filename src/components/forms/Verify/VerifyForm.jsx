    ...
    return (
      <div className="workflow-content">
        {quoteData && <div>
              ...
              <section className="display-element">
                ...
                <dl>
                  <div>
                    ...
                    <dd>${coverageLimits.dwelling.amount * (coverageLimits.ordinanceOrLaw.amount / 100)}</dd>
                  </div>
                </dl>
              </section>
          ...
          <Form className="fade-in" id="Verify" onSubmit={handleSubmit(this.handleOnSubmit)} noValidate>
            <div className="workflow-steps">
              <button disabled={!confirmProperyDetails || !confirmQuoteDetails || !confirmPolicyHolderDetails} className="btn btn-primary" type="submit" form="Verify">next</button>
            </div>
          </Form>
        </div>}
        <Footer/>
