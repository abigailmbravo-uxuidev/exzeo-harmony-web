...
describe('Error testing', () => {
  it('Renders and has a fatal error', () => {
    ...
    expect(getByText('Property does not qualify for automated quote').querySelector('i').className).toEqual('fa fa-exclamation-triangle');
    ...
    expect(getByText('email us').parentNode).toHaveAttribute('href', 'mailto:customerservice@typtap.com');
    expect(getByText('(844) 289-7968').parentNode).toHaveAttribute('href', 'tel:8442897968');
  });
