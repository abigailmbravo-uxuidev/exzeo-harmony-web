                    ...
                    <section>
                        <div id="Error">
                            <div className="detail-wrapper">
                                <h3 className="section-group-header error"><i className="fa fa-exclamation-triangle"/> Please contact us</h3>
                                <h4 className="error-message">This property does not qualify for automated quote</h4>
                                <ul>
