...
let EmailPopup = (props) => {
  console.log(props);
  return (
    <div className={props.showEmailPopup === true ? 'error-content active' : 'error-content'} role="article">
      <Form className={'fade-in'} id="SendEmail" onSubmit={props.handleSubmit(props.primaryButtonHandler)} noValidate>
            ...
            <div className="card card-csr">
              ...
              <div className="card-footer">
                <div className="btn-group">
                  <button className="btn btn-secondary" onClick={props.secondaryButtonHandler}>Cancel</button>
