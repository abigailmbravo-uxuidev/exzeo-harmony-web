...
import ConnectedApp, { Verify, handleFormSubmit, goToStep, handlePolicyHolderUpdate, scheduleDateModal } from './Verify';
      ...
      cg: {
        bb: {
          data: {
            ...
            model: {
              variables: [{
                name: 'getQuote', value: { result: quoteData }
              }]
            },
            uiQuestions: []
          }
        ...
        bb: {
          data: {
            ...
            model: {
              variables: [
                {
                  name: 'quote', value: { result: quoteData }
                }, {
                  name: 'getFinalQuote',
                  value: {
                    result: quoteData
