...
export const reviewUnderwritingExcception = {
  ...
  agentMessage: "This quote sucks. Due to previous claims history, underwriting review is required prior to binding.",
  internalMessage: "This quote sucks. Due to previous claims history, underwriting review is required prior to binding.",
  active: true
};
