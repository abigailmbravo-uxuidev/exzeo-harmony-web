...
const mock = {
  header: {
    ...
    banner: {
      className: 'workflow-banner ttic fl af3 quote',
      icon: 'af3',
      title: 'TypTap',
      subTitle: 'FL'
    }
  ...
  pages: [
    ...
    },
    {
      ...
      components: [
        ...
        {
          id: '342563a3-d8ad-4b27-bcb1-2fb56d618fe7',
          component: '$TITLE',
          dependencies: '',
          data: {
        ...
        {
          id: '405aac98-6099-4bb7-b774-43c5706cfd55',
          component: '$BILLING',
          dependencies: '',
          data: {
    ...
    },
    {
      ...
      components: [
        {
          id: 'f6f8f272-10db-47a2-b20e-05ff9a66b4c0',
          component: '$VERIFY',
          dependencies: '',
          data: {
            extendedProperties: {
