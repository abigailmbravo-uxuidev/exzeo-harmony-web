...
export const externalLinks = [
  {
    key: 1,
    productIcon: 'generic',
    url: 'https://TypTap-Commision-Schedule.pdf',
  ...
  },
  {
    key: 3,
    productIcon: 'home',
    url: 'https://TT-Pilot-Agents-one-pager.pdf',
  ...
  },
  {
    key: 4,
    productIcon: 'home',
    url: 'https://TT-HO3-Quick-Ref-Guide.pdf',
  ...
  {
    key: 5,
    url: 'http://TT-HO3-County-Map.pdf',
    productIcon: 'home',
  ...
  {
    key: 6,
    url: 'https://TypTap-Underwriting-Exception-Req.pdf',
    productIcon: 'home',
