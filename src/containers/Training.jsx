...
export const externalLinks = [
  {
    key: 1,
    productIcon: 'generic',
    url: `${process.env.REACT_APP_DOCUMENT_URL}/TypTap-Commision-Schedule.pdf`,
  ...
  },
  {
    key: 2,
    productIcon: 'generic',
    url: `${process.env.REACT_APP_DOCUMENT_URL}/Who-Is-TypTap.pdf`,
    title: 'Who Is TypTap',
  ...
  },
  {
    key: 3,
    productIcon: 'home',
    url: `${process.env.REACT_APP_DOCUMENT_URL}/TT-Pilot-Agents-one-pager.pdf`,
  ...
  },
  {
    key: 4,
    productIcon: 'home',
    url: `${process.env.REACT_APP_DOCUMENT_URL}/TT-HO3-Quick-Ref-Guide.pdf`,
  ...
  {
    key: 5,
    url: `${process.env.REACT_APP_DOCUMENT_URL}/TT-HO3-County-Map.pdf`,
    productIcon: 'home',
  ...
  {
    key: 6,
    url: `${process.env.REACT_APP_DOCUMENT_URL}/TypTap-Underwriting-Exception-Req.pdf`,
    productIcon: 'home',
