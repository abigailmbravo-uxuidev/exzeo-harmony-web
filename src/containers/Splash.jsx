                ...
                <div className="product-wrapper">
                  ...
                  <div className="product card">
                    ...
                    <div className="card-footer">
                      ...
                      <Link to={{ pathname: '/policySearch', state: { searchType: 'policy' } }} className="btn btn-action btn-block"><i className="fa fa-history" />Retrieve Policy</Link>
                    </div>
                  </div>
                </div>
              </div>
