                ...
                <div className="product-wrapper">
                  <div className="product card">
                    ...
                    <div className="card-footer">
                      <Link to="/search/address" className="btn btn-secondary btn-block"><i className="fa fa-plus" />New Quote</Link>
                      <Link to="/search/retrieve" className="btn btn-primary btn-block"><i className="fa fa-history" />Retrieve Quote</Link>
                      <Link to="/policy" className="btn btn-action btn-block"><i className="fa fa-history" />Retrieve Policy</Link>
                    </div>
                  </div>
                </div>
                <div className="exzeo" />
