...
const ScheduleDate = ({
  ...
  <div
    className="modal-lg modal schedule-date-modal"
    data-test="schedule-date-modal"
  >
    <div className="card card-schedule-date">
      <div className="card-header">
        <h4>
          <i className="fa fa-envelope" /> Send Application
        </h4>
      </div>
      <div className="card-block">
        <h3>Congratulations</h3>
        <p>
          You have successfully completed a {companyName} {productDescription}{' '}
          Quote.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            A copy will also be sent to you ({selectedAgent.emailAddress})
          </li>
        </ul>
        <p>
        ...
        <p>
          NOTE: All signatures must be completed within 10 days, or the
