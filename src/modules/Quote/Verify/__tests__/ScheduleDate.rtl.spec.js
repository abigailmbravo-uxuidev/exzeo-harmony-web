...
describe('Congragulations Schedule Date Modal testing', () => {
  ...
  it('POS:Checks Submit Button', () => {
    ...
    checkButton(getByTestId, { dataTest: 'modal-save', text: 'Save Quote, Continue Later' });
    checkButton(getByTestId, { dataTest: 'modal-submit', text: 'Send Application For Signature' });
  });
});
