...
export default (useConfig = false) => cy.server()
  ...
  .route('POST', '/svc?fetchQuotes', useConfig ? stub('fx:stubs/fetchQuotes') : 'fx:stubs/fetchQuotes').as('fetchQuotes')
  ...
  .route('POST', '/cg/complete?customizeDefaultQuote', useConfig ? stub('fx:stubs/complete/customizeDefaultQuote') : 'fx:stubs/complete/customizeDefaultQuote')
