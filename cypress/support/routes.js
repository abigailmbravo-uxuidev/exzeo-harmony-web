...
export default (useConfig = false) => cy.server()
  ...
  .route('POST', '/moveToTask?addAdditionalAIs', useConfig ? stub('fx:stubs/moveToTask-addAdditionalAIs') : 'fx:stubs/moveToTask-addAdditionalAIs')
  ...
  .route('POST', '/cg/complete?addAdditionalAIs', useConfig ? stub('fx:stubs/addAdditionalAIs') : 'fx:stubs/addAdditionalAIs')
